...
```bash
curl -X <?php echo e($parsedRoute['methods'][0]); ?> "<?php echo e(trim(config('app.docs_url') ?: config('app.url'), '/')); ?>/<?php echo e(ltrim($parsedRoute['uri'], '/')); ?>" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "<?php echo e(rtrim(config('app.docs_url') ?: config('app.url'), '/')); ?>/<?php echo e(ltrim($parsedRoute['uri'], '/')); ?>",
